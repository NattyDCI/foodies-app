...
export async function shareMeal(prevState, formData) {
    ...
    if (
      ...
      //it should be a serializable object. Wich for ex. shouldnt include any methods, because the content of the 
      // method would get lost. but you can return simple strings, nested objects or nested arrays.
      console.log("Validation result:", { message: "Invalid Input" });
      return {
